...
//최근에 추가됨 스펙에 추가된 지 얼마 안 된 문법입니다. 구식 브라우저는 폴리필(최신 문법을 구식 브라우저에서도 사용 할 수 있도록 해주는 것)이 필요합니다.
...
let height0 = 0;
console.log(height0 || 100);
//하이트가 없으면 100을 출력해
console.log(height0 ?? 100);
// 하이트가 0이기 때문에 100 안가져감

// 단락회로평가와 nullish 연산자 차이점
let height1 = 0;
console.log(height1 || 100);
console.log(height1 ?? 100);
